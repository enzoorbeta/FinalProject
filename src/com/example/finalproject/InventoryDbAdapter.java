...
public class InventoryDbAdapter {
	...
	// DO NOT REMOVE THIS ID
		...
		/*	public int getCount(long id) {
			...
			public ArrayList<Inventory> getArray()
			{
				Cursor mCursor = mDb.query(SQLITE_TABLE, new String[] { KEY_ROWID,
						KEY_NAME, KEY_COST, KEY_STOCK }, null, null, null, null, null);
				...
				if (mCursor.moveToFirst()) {
                    ...
                    do {
                    	...
                    	item.setName(mCursor.getString(mCursor.getColumnIndex(KEY_NAME)));
                    	item.setCost(mCursor.getString(mCursor.getColumnIndex(KEY_COST)));
                    	item.setStock(mCursor.getString(mCursor.getColumnIndex(KEY_STOCK)));
