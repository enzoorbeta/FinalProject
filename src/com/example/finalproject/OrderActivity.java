...
public class OrderActivity extends ActionBarActivity {
	...
	public ArrayList<String> itemsNames=new ArrayList<String>();
	public ArrayList<String> itemsStocks=new ArrayList<String>();
	
	private OrderDbAdapter dbHelper;
	private InventoryDbAdapter dbInv;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// INSTANCE DB ADAPTER
				...
				dbInv= new InventoryDbAdapter(this);
				// OPEN
				dbHelper.open();
				dbInv.open();
				...
				Cursor cursor1 = dbInv.fetchAllItems();
				
				for (Inventory s:dbInv.getArray())
				{
					itemsNames.add(s.getName());
				}
				for (Inventory s:dbInv.getArray())
				{
					itemsStocks.add(s.getStock());
				}
    ...
    public boolean onContextItemSelected(MenuItem item) {
      ...
      case R.id.edit:
    	  ...
    	  intent.putStringArrayListExtra("itemsName", itemsNames);
    	  intent.putStringArrayListExtra("itemsStock", itemsStocks);
